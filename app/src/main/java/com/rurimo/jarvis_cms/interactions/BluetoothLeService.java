...
import com.rurimo.jarvis_cms.R;
import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;
import java.util.UUID;

/** references: https://github.com/skydoves/MagicLight-Controller */
public class BluetoothLeService extends Service {
  ...
  /** @Callback Gatt Connection State Change CallBack & Send Broadcast (Updated State) */
  // region
      ...
      new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
          if (status == BluetoothGatt.GATT_SUCCESS) {
            ...
            broadcastUpdate(
                ACTION_GATT_SERVICES_DISCOVERED); // broadcast Gatt connection state : discovered
          } else {
  ...
  /** @ServiceBinder Service Local Binding & Initialize & Connect */
  // region
  ...
  private ArrayList<ArrayList<BluetoothGattCharacteristic>> getGattServices(
    ...
    for (BluetoothGattService gattService : gattServices) {
      ...
      currentServiceData.put(
          "LIST_NAME",
          BluetoothGattAttributes.INSTANCE.lookup(uuid, getString(R.string.unknown_service)));
      ...
      for (BluetoothGattCharacteristic gattCharacteristic : gattCharacteristics) {
        ...
        currentCharaData.put(
            "LIST_NAME",
            BluetoothGattAttributes.INSTANCE.lookup(
                uuid, getString(R.string.unknown_characteristic)));
  ...
  public void sendDataCharacteristic(BluetoothGattCharacteristic characteristic, byte[] value) {
    ...
    if (UUID.fromString(BluetoothGattAttributes.LED_CHARACTERISTIC)
